...
- **Full Documentation:** [TOOLS_INDEX.md](https://github.com/nostalgia2812/.github/blob/claude/tooling-filing-system-uG7Gs/TOOLS_INDEX.md#gitleaks)
...
./scripts/install_all.sh gitleaks
```
...
Results are available in the [GitHub Security tab](https://github.com/nostalgia2812/gitleaks/security/code-scanning).
